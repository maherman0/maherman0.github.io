...
<img width="300px" class="rounded float-start pe-4" src="../img/smart-questions/rtfm.png" alt="RTFM cartoon">
...
<div class="row g-3 my-4">
  <div class="col-md-6">
    <a href="../img/Img2.png" target="_blank">
      <img class="img-fluid rounded" src="../img/Img2.png" alt="Question description and web app source code">
    </a>
  </div>
  <div class="col-md-6">
    <a href="../img/Img3.png" target="_blank">
      <img class="img-fluid rounded" src="../img/Img3.png" alt="Download button function and question tags">
    </a>
  </div>
</div>
